"""
===========================================================================
TEMPORAL DISAGGREGATION PROFILE BUILDER - PUGLIA
===========================================================================
Description: 
...
# Provincial mapping codes for Puglia (Aligned with ISTAT COD_PROV standards)
PROV_ID_MAP = {
    'Foggia': 71,
    'Bari': 72,
    'Taranto': 73,
...
for file_path in res_files:
    try:
        ...
        # Robust province extraction from filenames
